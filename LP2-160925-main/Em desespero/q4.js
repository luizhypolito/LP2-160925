...
for (i = 0; i < 8; i++) {
    ...
    let valores1 = Number(prompt("Digite o nota dessa matéria:"))
    mat[i].nota = valores1

    let valores2 = Number(prompt("Digite a frequência dessa matéria:"))
    mat[i].freq = valores2
...
let result = mediaf * 100;
console.log("Média das Frequências em %: ", result.toFixed(2))
